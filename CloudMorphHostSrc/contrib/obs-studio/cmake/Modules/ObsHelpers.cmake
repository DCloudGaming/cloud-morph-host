...
if(DEFINED ENV{obsAdditionalInstallFiles})
	...
	set(ENV{obsAdditionalInstallFiles} "${CMAKE_SOURCE_DIR}/contrib/obs-studio/additional_install_files")
endif()
...
function(obs_helper_copy_dir target target_configs source dest)
	add_custom_command(TARGET ${target} POST_BUILD
		COMMAND "${CMAKE_COMMAND}"
			...
			"-DINPUT=${source}"
			"-DOUTPUT=${dest}"
			-P "${CMAKE_SOURCE_DIR}/contrib/obs-studio/cmake/copy_helper.cmake"
		VERBATIM)
endfunction()

function(obs_install_additional maintarget)
	set(addfdir "${CMAKE_SOURCE_DIR}/contrib/obs-studio/additional_install_files")
	if(DEFINED ENV{obsAdditionalInstallFiles})
...
function(obs_debug_copy_helper target dest)
	add_custom_command(TARGET ${target} POST_BUILD
		COMMAND "${CMAKE_COMMAND}"
			...
			"-DOUTPUT=${dest}"
			-P "${CMAKE_SOURCE_DIR}/contrib/obs-studio/cmake/copy_on_debug_helper.cmake"
		VERBATIM)
endfunction()
